...
private slots:
  ...
  void onEditorVisibilityChanged(bool isVisible);
  void onConsoleVisibilityChanged(bool isVisible);
  void onErrorLogVisibilityChanged(bool isVisible);
  void onViewportControlVisibilityChanged(bool isVisible);
  void onParametersVisibilityChanged(bool isVisible);
  void onAnimateVisibilityChanged(bool isVisible);
  void onFontListVisibilityChanged(bool isVisible);
